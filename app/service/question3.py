...
def commission_atom_v1(arg_list):
...
def commission_atom_v2(arg_list):
    host_price, display_price, peripheral_price = 25, 30, 45
    host_num, display_num, peripheral_num = arg_list[0], arg_list[1], arg_list[2]
    if host_num <= 0 or display_num <= 0 or peripheral_num <= 0 or \
            host_num > 70 or display_num > 80 or peripheral_num > 90:
...
commission_atom_v = {
    'v1': commission_atom_v1,
    'v2': commission_atom_v2
}
...
class Question3:
    ...
    @staticmethod
    def commission(method_type, code_version='v2'):
        ...
        for i in range(0, len(df)):
            ...
            output_1, output_2 = commission_atom_v[code_version](arg_list)
    ...
    def commission_method_test(request):
        ...
        sales, commission = commission_atom_v['v2'](arg_list)
